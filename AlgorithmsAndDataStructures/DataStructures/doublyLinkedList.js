...
function doublyLinkedList() {
  ...
  this.addToBeginning = (value) => {
    ...
    head.prev = newNode //point prev to newNode
...
let myDbLinkedList = new doublyLinkedList()

// myDbLinkedList.addToBeginning(4)
// myDbLinkedList.addToBeginning(5)

// console.log(myDbLinkedList.head())
